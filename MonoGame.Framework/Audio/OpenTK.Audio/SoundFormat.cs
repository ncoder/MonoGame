...
{ 
    ...
    { 
        ...
        public OpenTK.Audio.OpenAL.ALFormat SampleFormatAsOpenALFormat 
        { 
            get 
            { 
                switch (SampleFormat) 
                { 
                    case SampleFormat.Mono8: return OpenTK.Audio.OpenAL.ALFormat.Mono8; 
                    case SampleFormat.Mono16: return OpenTK.Audio.OpenAL.ALFormat.Mono16; 
                    case SampleFormat.Stereo8: return OpenTK.Audio.OpenAL.ALFormat.Stereo8; 
                    case SampleFormat.Stereo16: return OpenTK.Audio.OpenAL.ALFormat.Stereo16; 
    ...
    { 
        ...
        Mono8 = OpenTK.Audio.OpenAL.ALFormat.Mono8, 
        /// <summary>16 bits per sample, 1 channel.</summary> 
        Mono16 = OpenTK.Audio.OpenAL.ALFormat.Mono16, 
        /// <summary>8 bits per sample, 2 channels.</summary> 
        Stereo8 = OpenTK.Audio.OpenAL.ALFormat.Stereo8, 
        /// <summary>16 bits per sample, 2 channels.</summary> 
        Stereo16 = OpenTK.Audio.OpenAL.ALFormat.Stereo16 
    } 
